	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer border-0">
				<div class="modal-footer border-0">
    			<button type="button" id="completeMaintenance" class="btn btn-success" style="display: none;" onclick="room()">정비 완료</button>
    			<button type="button" id="completeRepair" class="btn btn-warning" style="display: none;" onclick="broken()">수리 완료</button>
    			<button type="button" id="assignRoom" class="btn btn-primary" style="display: none;" onclick="assignRoom()">배정</button>
    			<button type="button" id="rePair" class="btn btn-primary" style="display: none;" onclick="rePair()">수리배정</button>
