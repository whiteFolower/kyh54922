				...
				<div class="card">
					...
					<div class="table-top-box side">
						<nav class="button-box table-nav">
							<a href="#" class="btn btn-primary"><i class="fa-solid fa-bars"></i>등록</a> 
							<a href="#" class="btn btn-primary"><i class="fa-regular fa-paper-plane"></i>보내기</a>
							<!-- <a href="#" class="btn btn-primary"><i class="fa-regular fa-pen-to-square"></i>수정</a>
					...
					<div class="page-footer">
						<div class="paging">
							<ul class='pagination'>
								...
								<li class='1'><a class='page-link active' href='javascript:;' data-page='1'><span>1</span></a></li>
								<li>
									<a class='page-link' href='javascript:;' data-page='1'>
