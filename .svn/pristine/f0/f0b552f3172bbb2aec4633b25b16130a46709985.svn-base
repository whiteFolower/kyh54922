				...
				<div class="card">
					<div class="page-header">
						...
						<ul class="breadcrumbs mb-3">
							...
							<li class="separator"><i class="fa-solid fa-chevron-right"></i></li>
							<li class="nav-item"><a href="/pms/brokenroom/brokenList.do">고장객실 리스트</a></li>
							<li class="separator"><i class="fa-solid fa-chevron-right"></i></li>
							<li class="nav-item"><a href="#">객실수리완료 리스트</a></li>
						</ul>
					</div>
					<div class="table-top-box side">
						...
						<div class="right">
							<div>
								<a href="/pms/brokenroom/brokenRepairedList.do" style="font-size: 20px; padding-right: 30px;">수리예정:${readRepairedcount}</a>
								<a href="/pms/brokenroom/brokenRepairingList.do" style="font-size: 20px;">수리중:${readRepairingcount}</a>
								<a href="/pms/brokenroom/brokenRepairfinisList.do" style="font-size: 20px; padding-left: 30px;
							padding-right: 30px;">수리완료:${readRepairfinishcount}</a>
							</div>
						...
						<div class="m-table-outer">
							<div class="m-table-inner">
								<table class="table-header-fix table-input-in">
									...
									<tbody>
										<c:choose>
											<c:when test="${not empty brokenRepairfinisList }">
												<c:forEach items="${brokenRepairfinisList }" var="broken">
													<tr>
