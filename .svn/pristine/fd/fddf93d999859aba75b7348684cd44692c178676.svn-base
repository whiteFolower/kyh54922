...
//	public void annual(Model model, HttpServletRequest request) {
//		HttpSession session = request.getSession();
//		EmpVO empvo = (EmpVO)session.getAttribute("empvo");
//
//		AttencanceVO attvo =  approserivce.retrieveAttencanceByEmpId(empvo.getEmpId());
//
//		empvo.setAttencance(attvo);
//		System.out.println("AttencanceVO: " + attvo);  // 로그 추가
//
////		model.addAttribute("empvo", empvo);
