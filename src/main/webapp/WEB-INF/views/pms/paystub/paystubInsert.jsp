...
<!-- 								<span>기본급, 야근수당, 성과금을 입력 하고 자동입력 버튼을 누르면 자동입력 됩니다</span> -->
						...
						<div class="d-flex mb-3">
							<div class="d-flex pay-date-box">
								<p class="me-2">지급일</p>
								<div class="me-2">
									<form:input type="date" path="paystubPaydate"  cssClass="date-input" />
							...
							<div class="d-flex pay-date-box">
								<p class="me-2">정산기간</p>
								<div class="d-flex pay-date-box">
									<form:input type="date" path="paystubStdate" cssClass="date-input" />
									<form:errors path="paystubStdate" cssClass="text-danger" element="span" />
									<span class="ms-2 me-2">~</span>
									<form:input type="date" path="paystubEnddate"  cssClass="date-input" />
