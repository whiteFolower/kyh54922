						...
						<div class="m-table-outer">
							<div class="m-table-inner">
								<table class="table-header-fix table-input-in"  id="tbl-area">
									<tr>
										<td colspan="9" class="sub-title">1. 객실 판매실적</td>
									</tr>

									<tr>
										<td rowspan="2">구분</td>
										<td colspan="2">금일실적</td>
										<td colspan="2">월누계</td>
										<td colspan="2">년누계</td>
										<td colspan="2">목표달성률</td>
									</tr>
									...
									<tr>
										...
										<td class="price">월달성률%</td>
										<td class="price">연달성률%</td>
									</tr>
									<tr>
										<td>매출</td>
									...
									<tr>
										<td colspan="9" class="sub-title">2. 일일객실 판매내역</td>
									</tr>
									...
									<tr>
										<td class="go-left">업장후불</td>
										<td class="price">${payment.receivables }</td>
										<td></td>
										<td></td>
									...
									<tr>
										...
										<td></td>
										<td></td>
										<td class="go-left">후불계</td>
										<td class="price">${payment.payLater }</td>
										<td></td>
									</tr>

									<tr>
										<td colspan="9" class="sub-title">3. 추가요금</td>
									</tr>
