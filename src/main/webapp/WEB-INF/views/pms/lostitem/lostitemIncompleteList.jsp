				...
				<div class="card">
					<div class="page-header">
						...
						<ul class="breadcrumbs mb-3">
							...
							<li class="separator"><i class="fa-solid fa-chevron-right"></i></li>
							<li class="nav-item"><a href="#">미완료 리스트</a></li>
						</ul>
					</div>
					<div class="table-top-box side">
						...
						<div class="right">
							<div>
																<a href="/pms/lostitem/lostitemIncompleteList.do" style="font-size: 20px; padding-right: 20px;">미완료건 : ${LostitemIncompletecount}</a>
								<a href="/pms/lostitem/lostitemCompleteList.do" style="font-size: 20px; padding-left: 30px; 
							padding-right: 60px;">완료건 : ${Lostitemcompletecount}</a>
							</div>
						...
						<div class="m-table-outer">
							<div class="m-table-inner">
								<table class="table-header-fix table-input-in">
									...
									<tbody>
										<c:choose>
											<c:when test="${not empty LostitemIncompleteList }">
												<c:forEach items="${LostitemIncompleteList }" var="lostitem">
													<tr>
