										...
										<c:choose>
											<c:when test="${not empty rentalList }">
												<c:forEach items="${rentalList }" var="rental">
													<tr>
														<td><input type="checkbox" class="chk" data-hkrNo="${rental.hkrNo}" /></td>
                										<td id="${rental.hkrNo}">${rental.hkrNo}</td>
														<td>${rental.hkrDate } </a></td>
														<td>${rental.hkrRoom }호</a></td>
														<td>${rental.hkrCheckin } </a></td>
														<td>${rental.hkrCheckout } </a></td>
