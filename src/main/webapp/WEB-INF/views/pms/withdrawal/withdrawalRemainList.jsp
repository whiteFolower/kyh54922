						...
						<div class="m-table-outer">
							<div class="m-table-inner">
								<table class="table-header-fix table-input-in">
									...
									<tbody>
										<c:choose>
											<c:when test="${not empty remainList }">
												<c:forEach items="${remainList }" var="remainList">
													<tr>
														<td>${remainList.withdrawalDate }</td>
														<td>
															<c:url value="/withdrawal/withdrawalDetail.do" var="withDetailUrl">
																<c:param name="what" value="${remainList.withdrawalEnter }" />
															</c:url> <a href="${withDetailUrl }">${remainList.withdrawalNo } </a>
														</td>
														<td>${remainList.withdrawalEnter }</td>
														<td>${remainList.withdrawalBuyername }</td>
														<td>${remainList.withdrawalBank }</td>
														<td>${remainList.withdrawalBankno }</td>
														<td class="price">${remainList.withdrawalTotal }원</td>
														<td class="price">${remainList.withdrawalSend }원</td>
														<td class="price">${remainList.withdrawalRemain }원</td>
													</tr>
												</c:forEach>
											</c:when>
											<c:otherwise>
