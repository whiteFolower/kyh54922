...
<!-- 							비밀번호 입력: <input type="password" > -->
						...
						<div class="modal-footer border-0">
							<button type="submit" id="addRowButton" onclick="setAprContent()"
...
<!-- 		 <div class="d-flex align-items-left align-items-md-center flex-column pbot-4" > -->
	...
	<div class="headerline" >
		<div class="anntable">
		<form:form method="post" modelAttribute="empvo" enctype="multipart/form-data" action="/annual.do">
				...
				<tbody>
					<tr>
						<td style="width: 300px; padding: 3px !important; border: 0px solid black; height: 90px !important; font-size: 22px; font-weight: bold; text-align: center; vertical-align: middle;"
							...
							연차신청서<form:hidden path="pmsapproval.aprTitle" value="${empvo.pmsapproval.aprTitle}"/></td>
					</tr>
					<tr>
										...
										<td
											...
											<span unselectable="on" contenteditable="false" class="comp_wrap"
												...
												<span class="comp_item">${empvo.empName }
													<form:hidden path="pmsapproval.aprWriter" value="${empvo.pmsapproval.aprWriter}"/>
												</span>
									...
									<tr>
									    ...
									    <td style="width: 200px; padding: 3px !important; height: 22px; vertical-align: middle; border: 1px solid black; text-align: left;">
									        <span class="comp_item">
												...
												<form:hidden path="pmsapproval.aprRegdate" value="${empvo.pmsapproval.aprRegdate}"/>
									        </span>
									    </td>
									</tr>
	...
	<form:hidden path="pmsapproval.aprContent" id="aprContentHidden"/>
		<div id="annualLeaveContent">
...
function setAprContent(){
	var content = document.getElementById('annualLeaveContent').innerHTML;
	  var form = document.createElement('form');
	    form.method = 'POST';
	    form.action = '/pms/approvalform.do';


	    // hidden input 추가
	    var hiddenField = document.createElement('input');
	    hiddenField.type = 'hidden';
	    hiddenField.name = 'aprContent';
