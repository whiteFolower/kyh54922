...
<section id="tour">
	...
	<div id="room">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-title">다이닝</h3>
					<div class="swiper wow slideDown">
						<!-- Additional required wrapper -->
						<div class="swiper-wrapper">
							<!-- Slides -->
							<div class="swiper-slide">
								<img src="${cPath }/resources/PMS/image/다이닝.jpg" alt="" />
							</div>
							<div class="swiper-slide">
								<img src="${cPath }/resources/PMS/image/다이닝1.jpg" alt="" />
							</div>
							<div class="swiper-slide">
								<img src="${cPath }/resources/PMS/image/다이닝2.jpg" alt="" />
							</div>
						</div>
						<!-- 이전, 다음 버튼 필요시 추가 -->
