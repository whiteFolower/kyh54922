...
<section id="tour">
	...
	<div id="room">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-title">연회장</h3>
					<div class="swiper wow slideDown">
						<!-- Additional required wrapper -->
						<div class="swiper-wrapper">
							<!-- Slides -->
							<div class="swiper-slide">
								<img src="${cPath }/resources/PMS/image/연회장.png" alt="연회장" />
							</div>
							<div class="swiper-slide">
								<img src="${cPath }/resources/PMS/image/연회장1.png" alt="연회장" />
							</div>
							<div class="swiper-slide">
								<img src="${cPath }/resources/PMS/image/연회장2.png" alt="연회장" />
							</div>
						</div>
						<!-- 이전, 다음 버튼 필요시 추가 -->
